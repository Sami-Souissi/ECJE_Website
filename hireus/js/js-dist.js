if (
  ((function (e, t) {
          ...
          for (
            ...
            if (null != (e = arguments[s]))
              for (t in e)
                (n = a[t]),
                  a !== (r = e[t]) &&
                    (u && r && (T.isPlainObject(r) || (i = T.isArray(r)))
                      ? (i
                          ? ((i = !1), (o = n && T.isArray(n) ? n : []))
        ...
        globalEval: function (e) {
          ...
          (e = T.trim(e)) &&
            (1 === e.indexOf("use strict")
              ? (((t = E.createElement("script")).text = e),
    ...
    var p = (function (n) {
      ...
      function re(e, t, n, r) {
        ...
        if (
          !r &&
          ((t ? t.ownerDocument || t : b) !== C && S(t), (t = t || C), E)
        ) {
          if (11 !== p && (u = Q.exec(e)))
            if ((i = u[1])) {
              if (9 === p) {
      ...
      ((x = re.selectors =
        {
          ...
          pseudos: {
            ...
            lang: oe(function (n) {
              return (
                B.test(n || "") || re.error("unsupported lang: " + n),
        ...
        return (
          ...
          oe(function (e, t, n, r) {
            var i,
              ...
              f = g ? (v || (e ? p : u || m) ? [] : t) : d;
            if ((g && g(d, f, n, r), m))
              for (i = ve(f, l), m(i, [], n, r), o = i.length; o--; )
                (a = i[o]) && (f[l[o]] = !(d[l[o]] = a));
            if (e) {
              if (v || p) {
                if (v) {
        ...
        (g = re.tokenize =
          function (e, t) {
            ...
            for (a = e, s = [], l = x.preFilter; a; ) {
              ...
              (r = W.exec(a)) &&
                ((n = r.shift()),
                i.push({ value: n, type: r[0].replace(R, " ") }),
                (a = a.slice(n.length))),
              x.filter))
                !(r = X[o].exec(a)) ||
                  (l[o] && !(r = l[o](r))) ||
              ...
              (a = k(
                ...
                (r = function (e, t, n, r, i) {
                  ...
                  for (
                    ...
                    if (b && o) {
                      for (
                        a = 0, t || o.ownerDocument === C || (S(o), (n = !E));
                        (s = m[a++]);
          ...
          function (e, t, n, r) {
            ...
            if (((n = n || []), 1 === c.length)) {
              if (
                ...
                if (
                  !(t = (x.find.ID(a.matches[0].replace(ee, te), t) || [])[0])
                )
                  return n;
      ...
      if (((n = n || A), "string" == typeof e)) {
        ...
        if (r[1]) {
          if (
            ...
            T.merge(
              this,
              T.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : E, !0)
            ),
        ...
        function (r, i) {
          T.fn[r] = function (e, t) {
            ...
            return (
              ...
              1 < this.length &&
                (F[r] || T.uniqueSort(n), M.test(r) && n.reverse()),
              this.pushStack(n)
            );
          };
        }
    ...
    (T.Callbacks = function (r) {
      ...
      var i,
        ...
        u = -1,
        c = function () {
          for (a = r.once, o = i = !0; l.length; u = -1)
      ...
      T.extend({
        ...
        when: function (e) {
          ...
          if (1 < a)
            for (
              i = new Array(a), t = new Array(a), n = new Array(a);
              r < a;
              r++
            )
              o[r] && T.isFunction(o[r].promise)
                ? o[r]
                    .promise()
                    .progress(u(r, t, i))
                    .done(u(r, n, o))
      ...
      T.extend({
        ...
        ready: function (e) {
          (!0 === e ? --T.readyWait : T.isReady) ||
            ...
            (O.resolveWith(E, [T]),
            T.fn.triggerHandler &&
              (T(E).triggerHandler("ready"), T(E).off("ready")));
        },
      }),
        ...
        remove: function (e, t) {
          ...
          if (void 0 !== o) {
            if (void 0 === t) this.register(e);
              ...
              T.isArray(t)
                ? (r = t.concat(t.map(T.camelCase)))
                : ((i = T.camelCase(t)),
                  t in o
                    ? (r = [t, i])
                    : (r = (r = i) in o ? [r] : r.match(j) || [])),
                (n = r.length);
              for (; n--; ) delete o[r[n]];
            }
      ...
      T.fn.extend({
        data: function (r, e) {
          ...
          if (void 0 === r) {
            if (
              this.length &&
              ((i = U.get(o)), 1 === o.nodeType && !H.get(o, "hasDataAttrs"))
            ) {
              for (t = a.length; t--; )
                a[t] &&
                ...
                function (t) {
                  ...
                  if (o && void 0 === t) {
                    if (
                      ...
                      return e;
                    if (((n = T.camelCase(r)), void 0 !== (e = U.get(o, n))))
                      return e;
    ...
    function B(e, t, n, r) {
      var i,
        ...
        c = (T.cssNumber[t] || ("px" !== u && +l)) && W.exec(T.css(e, t));
      if (c && c[3] !== u)
        for (
          u = u || c[3], n = n || [], c = +l || 1;
          (c /= o = o || ".5"),
    ...
    (T.event = {
      ...
      dispatch: function (e) {
        ...
        if (
          ...
          for (
            a = T.event.handlers.call(this, e, l), t = 0;
      ...
      mouseHooks: {
        ...
        filter: function (e, t) {
          ...
          return (
            null == e.pageX &&
              null != t.clientX &&
              ((r = (n = e.target.ownerDocument || E).documentElement),
              (i = n.body),
              (e.pageX =
                t.clientX +
    ...
    function ye(e, t) {
      ...
      if (1 === t.nodeType) {
        if (
          H.hasData(e) &&
          ((o = H.access(e)), (a = H.set(t, o)), (u = o.events))
        )
    ...
    function be(n, r, i, o) {
      ...
      if (
        ...
        for (s = (a = T.map(Q(e, "script"), me)).length; c < d; c++)
          (l = e),
            c !== f &&
              ((l = T.clone(l, !0, !0)), s && T.merge(a, Q(l, "script"))),
            i.call(n[c], l, c);
        if (s)
          for (
            u = a[a.length - 1].ownerDocument, T.map(a, ve), c = 0;
            c < s;
            c++
          )
            (l = a[c]),
              G.test(l.type || "") &&
                ...
                (l.src
                  ...
                  : T.globalEval(l.textContent.replace(he, "")));
      }
      return n;
    }
    function xe(e, t, n) {
      for (var r, i = t ? T.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
        n || 1 !== r.nodeType || T.cleanData(Q(r)),
          r.parentNode &&
            (n && T.contains(r.ownerDocument, r) && Z(Q(r, "script")),
    ...
    T.extend({
      ...
      clone: function (e, t, n) {
        ...
        if (
          ...
          for (a = Q(c), r = 0, i = (o = Q(e)).length; r < i; r++)
            (s = o[r]),
              (l = a[r]),
              void 0,
              "input" === (u = l.nodeName.toLowerCase()) && X.test(s.type)
                ? (l.checked = s.checked)
                : ("input" !== u && "textarea" !== u) ||
                  (l.defaultValue = s.defaultValue);
        if (t)
          if (n)
            for (o = o || Q(e), a = a || Q(c), r = 0, i = o.length; r < i; r++)
              ye(o[r], a[r]);
          else ye(e, c);
      ...
      T.fn.extend({
        ...
        empty: function () {
          for (var e, t = 0; null != (e = this[t]); t++)
            1 === e.nodeType && (T.cleanData(Q(e, !1)), (e.textContent = ""));
          return this;
        },
        clone: function (e, t) {
          return (
          ...
          return D(
            ...
            function (e) {
              ...
              if (
                "string" == typeof e &&
                !de.test(e) &&
                !K[(Y.exec(e) || ["", ""])[1].toLowerCase()]
              ) {
                e = T.htmlPrefilter(e);
                try {
                  for (; n < r; n++)
                    1 === (t = this[n] || {}).nodeType &&
                      (T.cleanData(Q(t, !1)), (t.innerHTML = e));
                  t = 0;
                } catch (e) {}
              }
        ...
        replaceWith: function () {
          ...
          return be(
            ...
            function (e) {
              ...
              T.inArray(this, n) < 0 &&
                (T.cleanData(Q(this)), t && t.replaceChild(e, this));
            },
            n
          );
        },
    ...
    function Ee(e) {
      ...
      return (
        n ||
          (("none" !== (n = Ce(e, t)) && n) ||
            ((t = (we = (
              we || T("<iframe frameborder='0' width='0' height='0'/>")
    ...
    function Ne(e, t, n) {
      ...
      return (
        ("" !==
          (a = (n = n || ke(e)) ? n.getPropertyValue(t) || n[t] : void 0) &&
          void 0 !== a) ||
        ...
        (a.style.backgroundClip = "content-box"),
          ...
          T.extend(m, {
            ...
            reliableMarginRight: function () {
              var e,
                t = a.appendChild(E.createElement("div"));
              return (
    ...
    function Ie(e, t, n, r, i) {
      for (
        ...
        "margin" === n && (a += T.css(e, n + z[o], !0, i)),
          r
            ? ("content" === n && (a -= T.css(e, "padding" + z[o], !0, i)),
              "margin" !== n &&
                (a -= T.css(e, "border" + z[o] + "Width", !0, i)))
            : ((a += T.css(e, "padding" + z[o], !0, i)),
              "padding" !== n &&
                (a += T.css(e, "border" + z[o] + "Width", !0, i)));
      return a;
    }
    function $e(e, t, n) {
      ...
      if (i <= 0 || null == i) {
        if (
          (((i = Ne(e, t, o)) < 0 || null == i) && (i = e.style[t]), Ae.test(i))
        )
          return i;
        ...
        (r = e[a]).style &&
          ...
          t
            ? (o[a] || "none" !== n || (r.style.display = ""),
              "" === r.style.display &&
                _(r) &&
                (o[a] = H.access(r, "olddisplay", Ee(r.nodeName))))
            : ((i = _(r)),
              ("none" === n && i) ||
                H.set(r, "olddisplay", i ? n : T.css(r, "display"))));
      for (a = 0; a < s; a++)
        (r = e[a]).style &&
    ...
    T.extend({
      ...
      style: function (e, t, n, r) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          var i,
            ...
            l = e.style;
          return (
            (t = T.cssProps[s] || (T.cssProps[s] = He(s) || s)),
      ...
      T.each(["height", "width"], function (e, a) {
        T.cssHooks[a] = {
          get: function (e, t, n) {
            return t
              ? je.test(T.css(e, "display")) && 0 === e.offsetWidth
                ? Me(e, Pe, function () {
                    return $e(e, a, n);
                  })
                : $e(e, a, n)
          ...
          set: function (e, t, n) {
            var r,
              ...
              o =
                n &&
                Ie(e, a, n, "border-box" === T.css(e, "boxSizing", !1, i), i);
            return (
              o &&
                (r = W.exec(t)) &&
                "px" !== (r[3] || "px") &&
      ...
      (T.cssHooks.marginRight = Oe(m.reliableMarginRight, function (e, t) {
        return t
          ? Me(e, { display: "inline-block" }, Ne, [e, "marginRight"])
          : void 0;
      })),
    ...
    function Ze(e, t, n) {
      for (
        var r,
          i = (Je.tweeners[t] || []).concat(Je.tweeners["*"]),
          o = 0,
          a = i.length;
        o < a;
        o++
          ...
          1 === t.nodeType &&
            ...
            "inline" ===
              ("none" === (u = T.css(t, "display"))
                ? H.get(t, "olddisplay") || Ee(t.nodeName)
                : u) &&
              "none" === T.css(t, "float") &&
        ...
        stop: function (i, e, o) {
          ...
          return (
            ...
            this.each(function () {
              ...
              else for (t in r) r[t] && r[t].stop && Ge.test(t) && a(r[t]);
              for (t = n.length; t--; )
                n[t].elem !== this ||
                  (null != i && n[t].queue !== i) ||
      ...
      toggleClass: function (i, t) {
        ...
        return "boolean" == typeof t && "string" === o
          ...
          : this.each(function () {
              var e, t, n, r;
              if ("string" === o)
                for (t = 0, n = T(this), r = i.match(j) || []; (e = r[t++]); )
                  n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
              else
                (void 0 !== i && "boolean" !== o) ||
                  ((e = ot(this)) && H.set(this, "__className__", e),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
        ...
        return arguments.length
          ? ((i = T.isFunction(n)),
            this.each(function (e) {
              var t;
              1 === this.nodeType &&
                (null == (t = i ? n.call(this, e, T(this).val()) : n)
                  ? (t = "")
                  : "number" == typeof t
                  ? (t += "")
                  : T.isArray(t) &&
      ...
      trigger: function (e, t, n, r) {
        ...
        if (
          ...
          if (!r && !c.noBubble && !T.isWindow(n)) {
            for (
              s = c.delegateType || f, lt.test(s + f) || (o = o.parentNode);
              o;
              o = o.parentNode
            )
              d.push(o), (a = o);
          ...
          for (i = 0; (o = d[i++]) && !e.isPropagationStopped(); )
            (e.type = 1 < i ? s : c.bindType || f),
              (u = (H.get(o, "events") || {})[e.type] && H.get(o, "handle")) &&
                u.apply(o, t),
              (u = l && o[l]) &&
                u.apply &&
                L(o) &&
        ...
        T.each({ focus: "focusin", blur: "focusout" }, function (n, r) {
          ...
          T.event.special[r] = {
            ...
            teardown: function () {
              ...
              t
                ? H.access(e, r, t)
                : (e.removeEventListener(n, i, !0), H.remove(e, r));
            },
          };
        });
    var ut = C.location,
      ...
      T.extend({
        ...
        ajax: function (e, t) {
          ...
          if (
            ...
            (S.success = S.done),
            (S.error = S.fail),
            (g.url = ((e || g.url || ut.href) + "")
              .replace(ft, "")
              .replace(mt, ut.protocol + "//")),
          ...
          g.ifModified &&
            (T.lastModified[d] &&
              S.setRequestHeader("If-Modified-Since", T.lastModified[d]),
          ...
          if ((c = St(yt, g, t, S))) {
            if (
              ((S.readyState = 1), h && v.trigger("ajaxSend", [S, g]), 2 === w)
            )
              return S;
            g.async &&
              0 < g.timeout &&
          ...
          function l(e, t, n, r) {
            ...
            2 !== w &&
              ...
              (x = void 0),
              h &&
                v.trigger(i ? "ajaxSuccess" : "ajaxError", [S, g, i ? o : a]),
              b.fireWith(m, [S, u]),
              h &&
    ...
    function Ft(n, e, r, i) {
      ...
      else if (r || "object" !== T.type(e)) i(n, e);
    ...
    (T.fn.load = function (e, t, n) {
      ...
      var r,
        ...
        s = e.indexOf(" ");
      return (
        -1 < s && ((r = T.trim(e.slice(s))), (e = e.slice(0, s))),
        T.isFunction(t)
          ? ((n = t), (t = void 0))
      ...
      T.each(["top", "left"], function (e, n) {
        T.cssHooks[n] = Oe(m.pixelPosition, function (e, t) {
          return t
            ? ((t = Ne(e, n)), Ae.test(t) ? T(e).position()[n] + "px" : t)
            : void 0;
        });
      }),
    ...
    return (
      (T.noConflict = function (e) {
        return (
          C.$ === T && (C.$ = Ht), e && C.jQuery === T && (C.jQuery = qt), T
        );
      }),
      e || (C.jQuery = C.$ = T),
      T
        ...
        k = {
          isExternal: function (e) {
            ...
            return (
              ("string" == typeof t[1] &&
                0 < t[1].length &&
                t[1].toLowerCase() !== S.location.protocol) ||
              ("string" == typeof t[2] &&
                0 < t[2].length &&
                t[2].replace(
                  new RegExp(
                    ":(" +
                      { "http:": 80, "https:": 443 }[S.location.protocol] +
                      ")?$"
                  ),
                  ""
                ) !== S.location.host)
          ...
          shouldLoadAnchor: function (e, t, n) {
            ...
            return !(
              ...
              e.is(t) ||
              e.prop("target") ||
              (typeof n !== E && "" !== n && -1 === e.prop("href").search(n))
            );
          },
        ...
        n = function (e, s) {
          var t,
            ...
            p = function (e, t) {
              ...
              var i = k.translate(e);
              if (
                !(c = k.clearIfOverCapacity(c, s.cacheLength)).hasOwnProperty(
                  i.url
                ) ||
                void 0 !== i.data
              ) {
                c[i.url] = { status: "fetching" };
                var n = w.ajax(i);
                n.done(function (e) {
                  ...
                  s.locationHeader &&
                    n.always(function (e, t, n) {
                      var r = (e.statusCode ? e : n).getResponseHeader(
                        s.locationHeader
                      );
                      r && (c[i.url].destUrl = r);
                    }),
                ...
                t = {
                  loaded: function () {
                    ...
                    if (
                      ...
                      (d = s.alterChangeState({ id: u }, c[i.url].title, t)),
                        (c[i.url].state = d),
            ...
            a = function (e) {
              var t,
                n = w(e.currentTarget);
              k.shouldLoadAnchor(n, s.blacklist, s.hrefRegex) &&
                !i &&
                (e.stopPropagation(),
            ...
            g = function (e) {
              ...
              if (
                !e.metaKey &&
                !e.ctrlKey &&
                k.shouldLoadAnchor(t, s.blacklist, s.hrefRegex) &&
            ...
            m = function (e) {
              ...
              if (
                ...
                (i = !0),
                  "get" === (n = s.alterRequest(n)).type.toLowerCase() &&
                    (n.url = n.url + "?" + n.data),
                  s.onBefore(t, l),
            ...
            x = function (e) {
              s.anchors &&
                ...
                e
                  .find(s.anchors)
                  .not(s.prefetchBlacklist)
                  .on(s.prefetchOn, null, a);
            };
          return (
            (s = w.extend({}, w.fn.smoothState.options, s)),
            null === S.history.state
              ? ((d = s.alterChangeState({ id: u }, C.title, n)),
                S.history.replaceState(d, C.title, n))
              : (d = {}),
            k.storePageIn(c, n, C.documentElement.outerHTML, u, d),
            k.triggerAllAnimationEndEvent(
              l,
              "ss.onStartEnd ss.onProgressEnd ss.onEndEnd"
            ),
            (t = l),
            s.anchors && (t.on("click", s.anchors, g), x(t)),
      ...
      (S.onpopstate = function (e) {
        ...
        (w.fn.smoothState = function (t) {
          return this.each(function () {
            ...
            "body" !== e &&
            "html" !== e &&
            !w.data(this, "smoothState")
              ? w.data(this, "smoothState", new n(this, t))
              : !this.id && A
              ? A.warn(
  ...
  (window.Modernizr = (function (e, t, o) {
    ...
    var i,
      ...
      b = {}.hasOwnProperty;
    for (var x in ((l =
      a(b, "undefined") || a(b.call, "undefined")
        ? function (e, t) {
    ...
    return (
      (u.addTest = function (e, t) {
        if ("object" == typeof e)
          for (var n in e) l(e, n) && u.addTest(n, e[n]);
        else {
        ...
        p(e)
          ? (function (n, r, e, t, i, o, a) {
              ...
              1 === A[r] && ((c = 1), (A[r] = [])),
                ...
                "img" != n &&
                  (c || 2 === A[r]
                    ? (C.insertBefore(l, S ? null : b), y(s, a))
                    : A[r].push(l));
            })("c" == t ? u : l, e, t, this.i++, n, r, i)
          : (x.splice(this.i++, 0, e), 1 == x.length && m()),
        this
      );
    }
    function s() {
      var e = v;
      return (e.loader = { load: n, i: 0 }), e;
    }
    var r,
      v,
      i = f.documentElement,
      ...
      S = a && !!f.createRange().compareNode,
      C = S ? i : b.parentNode,
      l =
        ((i = e.opera && "[object Opera]" == o.call(e.opera)),
        (i = !!f.attachEvent && !i),
        a ? "object" : i ? "script" : "img"),
      u = i ? "script" : l,
      E =
        Array.isArray ||
        function (e) {
      ...
      function c(e, t, n, r, i) {
        var o = (function (e) {
            ...
            var t,
              ...
              o = e.pop(),
              a = e.length;
            for (o = { url: o, origUrl: o, prefixes: e }, n = 0; n < a; n++)
              (r = e[n].split("=")), (t = k[r.shift()]) && (o = t(o, r));
        ...
        for (var n in t) {
          ...
          for (var o in this.waypoints[n]) {
            ...
            if (null !== a.triggerPoint) {
              ...
              ((s && l) || (!s && !l)) &&
                (a.queueTrigger(i), (e[a.group.id] = a.group));
            }
          }
        }
        ...
        (e = {
          ...
          for (var a in this.waypoints[i]) {
            var s,
              ...
              u,
              c,
              d = this.waypoints[i][a],
              f = d.options.offset,
              p = d.triggerPoint,
              h = 0,
              g = null == p;
            d.element !== d.element.window &&
              (h = d.adapter.offset()[o.offsetProp]),
              "function" == typeof f
                ? (f = f.apply(d))
                : "string" == typeof f &&
                  ((f = parseFloat(f)),
                  -1 < d.options.offset.indexOf("%") &&
                    (f = Math.ceil((o.contextDimension * f) / 100))),
              ...
              (c = !l && !u),
              !g && l && u
                ? (d.queueTrigger(o.backward), (r[d.group.id] = d.group))
                : !g && c
                ? (d.queueTrigger(o.forward), (r[d.group.id] = d.group))
                : g &&
    ...
    function e(r) {
      return function () {
        var t = [],
          n = arguments[0];
        return (
          r.isFunction(arguments[0]) &&
            ((n = r.extend({}, arguments[1])).handler = arguments[0]),
          this.each(function () {
            var e = r.extend({}, n, { element: this });
            "string" == typeof e.context &&
              (e.context = r(this).closest(e.context)[0]),
              t.push(new i(e));
          }),
          t
        );
          ...
          $.proxy(function (e, t) {
            ...
            for (r = 0; r < o; r++) {
              ...
              (b = Math.max(b, d)),
                (b = Math.min(b, f)),
                p &&
                  (null == s.data("sens") && s.data("sens", "back"),
                  d < b &&
                    ("back" == s.data("sens")
                      ? ((v = 1), s.data("sens", "go"))
                      : v++),
                ...
                this._properties.map(
                  $.proxy(function (e) {
                    ...
                    if (null != n) {
                      ...
                      (o = Math.ceil(o * this.round) / this.round) == r &&
                        i == n &&
                        (o = n),
                        l[e] || (l[e] = 0),
                        (l[e] += o),
                        r != l[e] && (s.data("_" + e, l[e]), (u = !0));
                    }
                  }, this)
                );
            }
            if (u) {
              ...
              var S =
                ...
                " " +
                ("rotateX(" +
                  (l.rotateX ? l.rotateX : 0) +
                  "deg) rotateY(" +
                  (l.rotateY ? l.rotateY : 0) +
                  "deg) rotateZ(" +
                  (l.rotateZ ? l.rotateZ : 0) +
                  "deg)") +
                " " +
                ("scaleX(" +
                  l.scaleX +
              ...
              this._log(S),
                s.attr(
                  "style",
                  "transform:" + S + " -webkit-transform:" + S + " " + n
                );
            }
          }, this)
        ),
  ...
  E.fn.lightSlider = function (e) {
      ...
      C = {
        chbreakpoint: function () {
          if (((o = E(window).width()), c.responsive.length)) {
            var e;
            if (
              (!1 === c.autoWidth && (e = c.item),
              o < c.responsive[0].breakpoint)
            )
              for (var t = 0; t < c.responsive.length; t++)
                o < c.responsive[t].breakpoint &&
                  (c.responsive[t].breakpoint, (a = c.responsive[t]));
            if (null != a)
              for (var n in a.settings)
                a.settings.hasOwnProperty(n) &&
                  ((void 0 === i[n] || null === i[n]) && (i[n] = c[n]),
                  (c[n] = a.settings[n]));
            if (!E.isEmptyObject(i) && o > c.responsive[0].breakpoint)
              for (var r in i) i.hasOwnProperty(r) && (c[r] = i[r]);
            !1 === c.autoWidth &&
              0 < y &&
              0 < x &&
              e !== c.item &&
              (g = Math.round(y / ((x + c.slideMargin) * c.slideMove)));
          }
        },
        calSW: function () {
          !1 === c.autoWidth &&
            (x = (p - (c.item * c.slideMargin - c.slideMargin)) / c.item);
        },
        calWidth: function (e) {
          var t = !0 === e ? h.find(".lslide").length : u.length;
          if (!1 === c.autoWidth) f = t * (x + c.slideMargin);
          else
            for (var n = (f = 0); n < t; n++)
    ...
    return (
      (n = {
        ...
        keyPress: function () {
          c.keyPress &&
            E(document).on("keyup.lightslider", function (e) {
              E(":focus").is("input, textarea") ||
                (e.preventDefault ? e.preventDefault() : (e.returnValue = !1),
                37 === e.keyCode
                  ? d.goToPrevSlide()
                  : 39 === e.keyCode && d.goToNextSlide());
            });
        },
        controls: function () {
          c.controls &&
            ...
            c.autoWidth
              ? C.calWidth(!1) < p && h.find(".lSAction").hide()
              : s <= c.item && h.find(".lSAction").hide(),
        ...
        initialStyle: function () {
          ...
          "fade" === c.mode && ((c.autoWidth = !1), (c.slideEndAnimation = !1)),
              ...
              (C.clone = function () {
                if (C.calWidth(!0) > p) {
                  for (
                    ...
                    !(
                      (e +=
                        parseInt(d.find(".lslide").eq(n).width()) +
                        c.slideMargin) >=
                      p + c.slideMargin
                    ));
                    n++
                  ...
                  if (r < d.find(".clone.right").length)
                    for (
                      var o = u.length - 1;
                      o > u.length - 1 - d.find(".clone.right").length;
                      o--
                    )
                      g--, u.eq(o).remove();
                  ...
                  for (
                    var s =
                      d.find(".lslide").length - d.find(".clone.left").length;
                    s > d.find(".lslide").length - r;
                    s--
                  )
                    d.find(".lslide")
                      .eq(s - 1)
                  ...
                  u.hasClass("clone") &&
                    (d.find(".clone").remove(), l.move(d, 0));
              }),
              C.clone()),
            (C.sSW = function () {
              (s = u.length),
            ...
            "slide" === c.mode
              ? (C.calSW(),
                C.sSW(),
                !0 === c.loop && ((y = l.slideValue()), this.move(d, y)),
                !1 === c.vertical && this.setHeight(d, !1))
              : (this.setHeight(d, !0),
                d.addClass("lSFade"),
                this.doCss() || (u.fadeOut(0), u.eq(g).fadeIn(0))),
            !0 === c.loop && "slide" === c.mode
              ? u.eq(g).addClass("active")
        ...
        pager: function () {
          ...
          if (
            ((C.createPager = function () {
              w =
                (p - (c.thumbItem * c.thumbMargin - c.thumbMargin)) /
                c.thumbItem;
              var e = h.find(".lslide"),
              ...
              for (n = 0; n < t; n++) {
                "slide" === c.mode &&
                  (c.autoWidth
                    ? (i +=
                        (parseInt(e.eq(n).width()) + c.slideMargin) *
                        c.slideMove)
                    : (i = n * (x + c.slideMargin) * c.slideMove));
                ...
                if (
                  ...
                  c.autoWidth &&
                    ...
                    (a = 1)),
                    n < a
                      ? ((r = null), h.parent().addClass("noPager"))
                      : h.parent().removeClass("noPager");
                  break;
                }
              }
              var s = h.parent();
              s.find(".lSPager").html(r),
                !0 === c.gallery &&
                  (!0 === c.vertical &&
                    s.find(".lSPager").css("width", c.vThumbWidth + "px"),
                  (b = n * (c.thumbMargin + w) + 0.5),
                  s
                    .find(".lSPager")
                    .css({
                      property: b + "px",
                  ...
                  !0 === c.vertical &&
                    h
                      ...
                      .css(
                        "padding-right",
                        c.vThumbWidth + c.galleryMargin + "px"
                      ),
                ...
                l.on("click", function () {
                  return (
                    !0 === c.loop && "slide" === c.mode
                      ? (g +=
                          l.index(this) -
                          s.find(".lSPager").find("li.active").index())
                      : (g = l.index(this)),
                    d.mode(!1),
        ...
        setHeight: function (r, i) {
          ...
          var t = function () {
            var e = o.outerHeight(),
              ...
              n = e;
            i && ((e = 0), (t = (100 * n) / p)),
              r.css({ height: e + "px", "padding-bottom": t + "%" });
          };
          t(),
            o.find("img").length
              ? o.find("img")[0].complete
                ? (t(), l || e.auto())
          ...
          g * c.slideMove < s
            ...
            : (e.removeClass("active"),
              ...
              this.doCss() ||
                "fade" !== c.mode ||
                !1 !== t ||
                (e.fadeOut(c.speed), e.eq(i).fadeIn(c.speed)));
        },
        move: function (e, t) {
          !0 === c.rtl && (t = -t),
            this.doCss()
              ...
              ? e
                  ...
                  .animate({ top: -t + "px" }, c.speed, c.easing)
              : e
                  .css("position", "relative")
                  .animate({ left: -t + "px" }, c.speed, c.easing);
        ...
        slide: function () {
          ...
          (C.calSlide = function () {
            p < f &&
              ...
              !0 === c.loop &&
                "slide" === c.mode &&
                (g >= s - d.find(".clone.left").length / c.slideMove &&
                  e.resetSlide(d.find(".clone.left").length),
        ...
        slideValue: function () {
          var e = 0;
          if (!1 === c.autoWidth) e = g * (x + c.slideMargin) * c.slideMove;
          else
            for (var t = (e = 0); t < g; t++)
        ...
        touchMove: function (e, t) {
          if ((h.css("transition-duration", "0ms"), "slide" === c.mode)) {
            ...
            if (n >= f - p - c.slideMargin)
              if (!1 === c.freeMove) n = f - p - c.slideMargin;
              else {
        ...
        touchEnd: function (e) {
          if (
            (h.css("transition-duration", c.speed + "ms"), "slide" === c.mode)
          ) {
            var o = !1,
              t = !0;
            (y -= e) > f - p - c.slideMargin
              ? ((y = f - p - c.slideMargin), !1 === c.autoWidth && (o = !0))
              : y < 0 && (y = 0);
            var n = function (e) {
              var t = 0;
              if ((o || (e && (t = 1)), c.autoWidth))
                for (
                  var n = 0, r = 0;
                  r < u.length &&
                  ((n += parseInt(u.eq(r).width()) + c.slideMargin),
                  (g = r + t),
                  !(y <= n));
                  r++
                );
            ...
            e >= c.swipeThreshold
              ? (n(!1), (t = !1))
              : e <= -c.swipeThreshold && (n(!0), (t = !1)),
              d.mode(t),
              this.slideThumb();
          } else
            e >= c.swipeThreshold
              ? d.goToPrevSlide()
              : e <= -c.swipeThreshold && d.goToNextSlide();
        },
        enableDrag: function () {
          var n = this;
          if (!S) {
            ...
            h.find(".lightSlider").addClass("lsGrab"),
              h.on("mousedown", function (e) {
                return (
                  !(f < p && 0 !== f) &&
                  void (
                    "lSPrev" !== E(e.target).attr("class") &&
                    "lSNext" !== E(e.target).attr("class") &&
                    ((r = !0 === c.vertical ? e.pageY : e.pageX),
                    (o = !0),
                    e.preventDefault
                      ? e.preventDefault()
                      : (e.returnValue = !1),
              ...
              E(window).on("mouseup", function (e) {
                if (o) {
                  h.find(".lightSlider")
                    ...
                    .addClass("lsGrab");
                  var t =
                    (i = !(o = !1) === c.vertical ? e.pageY : e.pageX) - r;
                  Math.abs(t) >= c.swipeThreshold &&
                    E(window).on("click.ls", function (e) {
                      e.preventDefault
                        ? e.preventDefault()
                        : (e.returnValue = !1),
          ...
          if (S) {
            ...
            h.on("touchstart", function (e) {
              ...
              h.on("touchmove", function (e) {
                ...
                !0 === c.vertical
                  ? (n < 3 * r && e.preventDefault(),
                    i.touchMove(a.pageY, o.pageY))
                  : (r < 3 * n && e.preventDefault(),
      ...
      (C.init = function () {
        C.chbreakpoint(),
          !0 === c.vertical
            ? ((p = 1 < c.item ? c.verticalHeight : u.outerHeight()),
              h.css("height", p + "px"))
            : (p = h.outerWidth()),
          !0 === c.loop && "slide" === c.mode && C.clone(),
          C.calL(),
          "slide" === c.mode && d.removeClass("lSSlide"),
          "slide" === c.mode && (C.calSW(), C.sSW()),
          setTimeout(function () {
          ...
          !0 === c.adaptiveHeight &&
            !1 === c.vertical &&
            d.css("height", u.eq(g).outerHeight(!0)),
          !1 === c.adaptiveHeight &&
            ("slide" === c.mode
              ? !1 === c.vertical
                ? n.setHeight(d, !1)
          ...
          !1 === c.autoWidth
            ? u.length <= c.item
              ? h.find(".lSAction").hide()
              : h.find(".lSAction").show()
            : C.calWidth(!1) < p && 0 !== f
            ? h.find(".lSAction").hide()
            : h.find(".lSAction").show();
      }),
      (d.goToPrevSlide = function () {
        if (0 < g)
          ...
          if ((c.onBeforePrevSlide.call(this, d, g), "fade" === c.mode))
      ...
      (d.goToNextSlide = function () {
        ...
        g * c.slideMove < s - c.slideMove && e
          ? (c.onBeforeNextSlide.call(this, d, g),
            g++,
            d.mode(!1),
            !0 === c.gallery && n.slideThumb())
          : !0 === c.loop
          ...
          !1 === t &&
            ("slide" === c.mode
              ? n.doCss() &&
                ...
                "" !== c.cssEasing &&
                  h.css("transition-timing-function", c.cssEasing))
              : n.doCss() &&
                ("" !== c.speed && d.css("transition-duration", c.speed + "ms"),
                "" !== c.cssEasing &&
                  d.css("transition-timing-function", c.cssEasing))),
...
!(function (e, t) {
  ...
  function w(e, t) {
    for (
      var n = e.length, r = 2 <= arguments.length ? t : void 0, i = [], o = 0;
      o < n;
      o++
    )
      if (o in e) {
  ...
  function h(e, t) {
    return O.dom(e) && a(N, t)
      ? "transform"
      : O.dom(e) && (e.getAttribute(t) || (O.svg(e) && e[t]))
      ? "attribute"
      : O.dom(e) && "transform" !== t && S(e, t)
      ? "css"
      : null != e[t]
      ? "object"
      : void 0;
    ...
    switch (h(e, t)) {
      case "transform":
        return (function (e, n) {
          var t,
            r =
              -1 < (t = n).indexOf("translate") || "perspective" === t
                ? "px"
  ...
  function x(e, n) {
    ...
    if (O.arr(e)) {
      var r = e.length;
      2 !== r || O.obj(e[0])
        ? O.fnc(n.duration) || (t.duration = n.duration / r)
        : (e = { value: e });
    }
    return o(e)
      .map(function (e, t) {
  ...
  function E(o, a) {
    ...
    return o.tweens.map(function (e) {
      var t = (e = (function (e, t) {
        ...
        n = c(a.target, o.name),
        r = s ? s.to.original : n,
        i = ((r = O.arr(t) ? t[0] : r), g(O.arr(t) ? t[1] : t, r));
      n = l(i) || l(r) || l(n);
      return (
        (e.from = y(r, n)),
        (e.to = y(i, n)),
    ...
    var t,
      ...
      l =
        ...
        (r = b(n)).map(function (e, t) {
          return { target: e, id: t, total: r.length };
        })),
      u = [],
      c = p(a, s);
    for (t in e)
      c.hasOwnProperty(t) ||
        "targets" === t ||
        u.push({ name: t, offset: c.offset, tweens: x(e[t], s) });
    return (
      (o = u),
      p(a, {
        children: [],
  ...
  function A(e) {
      ...
      for (var e = 0, n = {}, r = x.animations, i = r.length; e < i; ) {
        ...
        for (
          var l =
              ...
              s.duration,
            u = isNaN(l) ? 1 : s.easing(l, s.elasticity),
            c = ((l = s.to.strings), s.round),
            d = [],
            f = void 0,
            p = ((f = s.to.numbers.length), 0);
          p < f;
          p++
        ) {
          var h = void 0,
            g = ((h = s.to.numbers[p]), s.from.numbers[p]);
    ...
    function t(e) {
      ...
      if (x.children.length) {
        var s = x.children,
          l = s.length;
        if (a >= x.currentTime) for (var u = 0; u < l; u++) s[u].seek(a);
        else for (; l--; ) s[l].seek(a);
      }
      (r <= a || !t) && (x.began || ((x.began = !0), p("begin")), p("run")),
        n < a && a < t
          ? f(a)
          : (a <= n && 0 !== i && (f(0), o && h()),
            ((t <= a && i !== t) || !t) && (f(t), o || h())),
        ...
        t <= e &&
          (x.remaining
            ? ((m = g),
              "alternate" === x.direction && (x.reversed = !x.reversed))
            : (x.pause(),
              x.completed ||
                ((x.completed = !0),
                p("complete"),
                "Promise" in window && (y(), (b = c())))),
          (v = 0));
    }
    e = void 0 === e ? {} : e;
    var g,
  ...
  var k,
    ...
    j = (function () {
      ...
      return function (a, s, l, u) {
        if (0 <= a && a <= 1 && 0 <= l && l <= 1) {
          ...
          if (a !== s || l !== u)
            for (var e = 0; e < 11; ++e) c[e] = d(0.1 * e, a, l);
          return function (e) {
            if (a === s && l === u) return e;
            if (0 === e) return 0;
            if (1 === e) return 1;
            for (var t = 0, n = 1; 10 !== n && c[n] <= e; ++n) t += 0.1;
            n = t + ((e - c[--n]) / (c[n + 1] - c[n])) * 0.1;
            var r =
              3 * (1 - 3 * l + 3 * a) * n * n + 2 * (3 * l - 6 * a) * n + 3 * a;
            if (0.001 <= r) {
              for (
                t = 0;
                t < 4 &&
    ...
    P = (function () {
      ...
      var e,
        ...
        i = { linear: j(0.25, 0.25, 0.75, 0.75) },
        o = {};
      for (e in t)
        (o.type = e),
          t[o.type].forEach(
            (function (n) {
              return function (e, t) {
                i["ease" + n.type + r[t]] = O.fnc(e)
                  ? e
                  : j.apply($jscomp$this, e);
              };
            })(o)
          ),
          (o = { type: o.type });
  ...
  return (
    ...
    (A.path = function (e, t) {
      var n = O.str(e) ? i(e)[0] : e,
        r = t || 100;
      return function (e) {
        return { el: n, property: e, totalLength: v(n) * (r / 100) };
      };
    }),
  ...
  (function (e) {
    ...
    return (
      (function e(t) {
        for (
          var n = [].slice.call(t.childNodes), r = n.length, i = -1;
          ++i < r;
        ...
        t.nodeType === Node.TEXT_NODE &&
          (function (e) {
            for (
              var t = e.parentNode, n = e.nodeValue, r = n.length, i = -1;
              ++i < r;
        ...
        return (
          ...
          (e.prototype.start = function () {
            ...
            if (
              ...
              (this.all = function () {
                var e, t, n, r;
                for (r = [], e = 0, t = (n = this.boxes).length; e < t; e++)
                  (i = n[e]), r.push(i);
                return r;
              }.call(this)),
              this.boxes.length)
          ...
          (e.prototype.doSync = function (e) {
            ...
            if ((null == e && (e = this.element), 1 === e.nodeType)) {
              for (
                o = [],
                  n = 0,
                  r = (i = (e = e.parentNode || e).querySelectorAll(
                    "." + this.config.boxClass
                  )).length;
                n < r;
                n++
              ...
              (a = e[o]),
                ...
                t.push(
                  function () {
                    var e, t, n, r;
                    for (
                      r = [], e = 0, t = (n = this.vendors).length;
                      e < t;
                      e++
                    )
                      (s = n[e]),
                        r.push(
                          (i["" + s + o.charAt(0).toUpperCase() + o.substr(1)] =
                            a)
                        );
                    return r;
                  }.call(this)
          ...
          (e.prototype.vendorCSS = function (e, t) {
            var n, r, i, o, a, s;
            for (
              o = (a = l(e)).getPropertyCSSValue(t),
                n = 0,
                r = (i = this.vendors).length;
              n < r;
              n++
            )
              (s = i[n]), (o = o || a.getPropertyCSSValue("-" + s + "-" + t));
            return o;
          }),
    ...
    !(function (s, e) {
      ...
      (s.fn.validateForm = function (e, t) {
        ...
        s(window).on(
          ...
          function (e, t, n) {
            ...
            t || (t = s("form")),
              (i = n) &&
                "custom" === i.errorMessagePosition &&
                "function" == typeof i.errorMessageCustom &&
                (s.formUtils.warn(
              ...
              (r = (a = t).find("[data-validation-if-checked]")).length &&
                s.formUtils.warn(
      ...
      (function (u) {
        ...
        var i = {
          resolveErrorMessage: function (e, t, n, r, i) {
            var o =
                r.validationErrorMsgAttribute +
                "-" +
                n.replace("validate_", ""),
              a = e.attr(o);
            return (
              a ||
                (a = e.attr(r.validationErrorMsgAttribute)) ||
                (a =
                  "function" != typeof t.errorMessageKey
                    ? i[t.errorMessageKey]
                    : i[t.errorMessageKey(r)]) ||
                (a = t.errorMessage),
              a
            );
          },
          getParentContainer: function (e) {
            ...
            var t = e.parent();
            if (
              !t.hasClass("form-group") &&
              !t.closest("form").hasClass("form-horizontal")
            ) {
          ...
          removeInputStylingAndMessage: function (e, t) {
            e.removeClass("valid")
              .removeClass(t.errorElementClass)
              .css("border-color", "");
            var n = i.getParentContainer(e);
            if (
              (n
                .removeClass(t.inputParentClassOnError)
                .removeClass(t.inputParentClassOnSuccess),
          ...
          setInlineMessage: function (t, n, r) {
            ...
            var i,
              e = document.getElementById(t.attr("name") + "_err_msg"),
              o = !1,
              a = function (e) {
              ...
              s = function () {
                ...
                o.find("." + r.errorMessageClass).each(function () {
                  ...
                  e
                    ...
                    : "" !== n &&
                      ((i = u(
                        '<div class="' + r.errorMessageClass + ' alert"></div>'
                      )),
                      a(i),
            ...
            if (e)
              ...
              0 ===
                (i = l.find("." + r.errorMessageClass + ".help-block"))
                  .length &&
                (i = u("<span></span>")
                  .addClass("help-block")
                  .addClass(r.errorMessageClass)).appendTo(l),
                a(i);
            }
          },
          setMessageInTopOfForm: function (e, t, n, r) {
            ...
            if (
              ...
              (o = n.submitErrorMessageCallback(e, t, n))
            ) {
              var a = {
        ...
        u.formUtils = u.extend(u.formUtils || {}, { dialogs: i });
      })(e),
      (function (f, u, e) {
        "use strict";
        var i = 0;
        (f.fn.validateOnBlur = function (n, r) {
            ...
            e.each(function () {
              ...
              if (e.is("[type=radio]")) {
                ...
                t.bind("blur.validation", function () {
                  ...
                  r.validateCheckboxRadioOnClick &&
            ...
            return (
              ("FORM" === this[0].nodeName
                ...
                t &&
                  e
                    .unbind(t + ".validation")
                    .bind(t + ".validation", function (e) {
                      9 !== (e || {}).keyCode &&
                        f(this).validateInputOnBlur(n, r, !0, t);
                    });
              }),
              this
            );
          ...
          (f.fn.validateInputOnBlur = function (t, n, e, r) {
            if (((f.formUtils.eventType = r), this.willPostponeValidation())) {
              ...
              return (
                (u.postponedValidation = function () {
            ...
            return (
              e && a.unbind("keyup.validation"),
              l.shouldChangeDisplay &&
                (l.isValid
                  ? f.formUtils.dialogs.applyInputSuccessStyling(a, n)
                  : f.formUtils.dialogs.setInlineMessage(a, l.errorMsg, n)),
              !l.isValid &&
                e &&
                a.bind("keyup.validation", function (e) {
                  9 !== e.keyCode &&
                    f(this).validateInputOnBlur(t, n, !1, "keyup");
                }),
              this
            );
          }),
          ...
          (f.fn.isValid = function (s, l, n) {
            ...
            (l = f.extend({}, f.formUtils.defaultConfig(), l || {})),
              ...
              (n = !1 !== n),
              f.formUtils.errorDisplayPreventedWhenHalted &&
                (delete f.formUtils.errorDisplayPreventedWhenHalted, (n = !1)),
            ...
            var u = function (e, t) {
              ...
              d = this;
            if (
              (n && f.formUtils.dialogs.removeAllMessagesAndStyling(d, l),
              d
                  ...
                  if (
                    ...
                    a.isValid
                      ? a.isValid &&
                        ...
                        f.formUtils.dialogs.applyInputSuccessStyling(n, l))
                      : u(a.errorMsg, n);
                  }
                }),
            ...
            return (
              (f.formUtils.isValidatingEntireForm = !1),
              !f.formUtils.haltValidation && 0 < i.length
                ? (n &&
                    ("top" === l.errorMessagePosition
                      ? f.formUtils.dialogs.setMessageInTopOfForm(d, r, l, s)
                      : f.each(i, function (e, t) {
                          f.formUtils.dialogs.setInlineMessage(
                            t,
                            t.attr("current-error"),
                            l
                          );
                        }),
                    l.scrollToTopOnError &&
                      f.formUtils.$win.scrollTop(d.offset().top - 20)),
                  !1)
                : (!n &&
                    f.formUtils.haltValidation &&
                    (f.formUtils.errorDisplayPreventedWhenHalted = !0),
                  !f.formUtils.haltValidation)
            );
          }),
          ...
          (f.fn.addSuggestions = function (t) {
            ...
            return (
              this.find("input").each(function () {
                var e = f(this);
                0 < (n = f.split(e.attr("data-suggestions"))).length &&
                  !e.hasClass("has-suggestions") &&
                  (f.formUtils.suggest(e, n, t), e.addClass("has-suggestions"));
              }),
              this
            );
          });
            ...
            if (u.formUtils.isLoadingModules)
              ...
              var l = !1,
                n = function (e, i) {
                  var t = u.split(e),
                    ...
                    o = function () {
                      0 === --n &&
                        ((u.formUtils.isLoadingModules = !1),
                  ...
                  u.each(t, function (e, t) {
                    if (0 === (t = u.trim(t)).length) o();
                    else {
                      var n = i + t + (".js" === t.slice(-3) ? "" : ".js"),
                        r = document.createElement("SCRIPT");
                      n in u.formUtils.loadedModules
                        ? o()
                        : ((u.formUtils.loadedModules[n] = 1),
                          (l = !0),
                          ...
                          (r.onerror = function () {
                            u.formUtils.warn(
                              "Unable to load form validation module " + n
                            );
                          }),
                          (r.onreadystatechange = function () {
              ...
              if (e) n(t, e);
                ...
                var i = function () {
                  var e = !1;
                  return (
                    u('script[src*="form-validator"]').each(function () {
                      return (
                        "/" ===
                          (e =
      ...
      (function (o) {
        ...
        (o.split = function (e, n) {
          if ("function" != typeof n) {
            ...
            var r = [];
            return (
              o.each(e.split(n || /[,|\-\s]\s*/g), function (e, t) {
          ...
          e &&
            o.each(e.split(/[,|\-\s]\s*/g), function (e, t) {
          ...
          (o.validate = function (i) {
            ...
            o(i.form).each(function (e, t) {
              ...
              n.trigger("formValidationSetup", [n, i]),
                ...
                n
                  .bind("submit.validation", function (e) {
                    ...
                    return o.formUtils.haltValidation
                      ? n()
                      : r && "function" == typeof i.onSuccess
                      ? !1 === i.onSuccess(t)
                        ? n()
                        : void 0
                      : r || "function" != typeof i.onError
                      ? !!r || n()
                      : (i.onError(t), n());
                  })
              ...
              "" !== i.modules &&
                o.formUtils.loadModules(i.modules, !1, function () {
        ...
        p.formUtils = p.extend(p.formUtils || {}, {
          ...
          warn: function (e) {
            "console" in t
              ? "function" == typeof t.console.warn
                ? t.console.warn(e)
                : "function" == typeof t.console.log && t.console.log(e)
              : alert(e);
          },
          ...
          validateInput: function (n, r, i, o, a) {
            ...
            n.valAttr("skipped", !1)
              .one("beforeValidation", function () {
                (n.attr("disabled") ||
                  (!n.is(":visible") && !i.validateHiddenInputs)) &&
                  n.valAttr("skipped", 1);
              })
            ...
            var e = "true" === n.valAttr("optional"),
              ...
              u = !0,
              c = "",
              d = { isValid: !0, shouldChangeDisplay: !0, errorMsg: "" };
            if (!l || t || n.valAttr("skipped"))
              return (d.shouldChangeDisplay = i.addValidClassOnAll), d;
            var f = n.valAttr("ignore");
            return (
              f &&
                p.each(f.split(""), function (e, t) {
                ...
                function (e) {
                  ...
                  return (
                    "validate_checkbox_group" === e &&
                      (n = o.find('[name="' + n.attr("name") + '"]:eq(0)')),
                    ("keyup" !== a || t.validateOnKeyUp) &&
                      (u = t.validatorFunction(s, n, i, r, o)),
                    u
                      ? void 0
                      : ((c = p.formUtils.dialogs.resolveErrorMessage(
                          n,
                          t,
                          e,
                          i,
              ...
              !1 === u
                ? (n.trigger("validation", !1),
                  (d.errorMsg = c),
                  (d.isValid = !1),
                  (d.shouldChangeDisplay = !0))
                : null === u
                ? (d.shouldChangeDisplay = !1)
                : (n.trigger("validation", !0), (d.shouldChangeDisplay = !0)),
              "function" == typeof i.onElementValidate &&
                null !== c &&
                i.onElementValidate(d.isValid, n, o, c),
          ...
          parseDate: function (e, t, n) {
            var r,
              ...
              o,
              a,
              s = t.replace(/[a-zA-Z]/gi, "").substring(0, 1),
              l = "^",
              u = t.split(s || null);
            if (
              (p.each(u, function (e, t) {
                l += (0 < e ? "\\" + s : "") + "(\\d{" + t.length + "})";
              }),
              (l += "$"),
              n)
            ...
            return (
              ...
              !(
                ...
                !(
                  (this.isShortMonth(o) && 30 < i) ||
                  (!this.isShortMonth(o) && 31 < i) ||
                  0 === i
                ) && [a, o, i]
            );
          },
                ...
                .bind("keydown.validation", function (e) {
                  ...
                  if (13 === r && null !== p.formUtils._selectedSuggestion) {
                    if (
                      ...
                      var o = n
                        .find("div")
                        .eq(p.formUtils._selectedSuggestion)
                        .text();
                    ...
                    if (0 < a.length && -1 < p.inArray(r, [38, 40])) {
                      38 === r
                        ? (null === p.formUtils._selectedSuggestion
                            ? (p.formUtils._selectedSuggestion = a.length - 1)
                            : p.formUtils._selectedSuggestion--,
                          p.formUtils._selectedSuggestion < 0 &&
                            (p.formUtils._selectedSuggestion = a.length - 1))
                        : 40 === r &&
                          (null === p.formUtils._selectedSuggestion
                            ? (p.formUtils._selectedSuggestion = 0)
                      ...
                      var s = n.innerHeight(),
                        l = n.scrollTop(),
                        u =
                          n.children().eq(0).outerHeight() *
                          p.formUtils._selectedSuggestion;
                      return (
                        (u < l || l + s < u) && n.scrollTop(u),
                        a
                          .removeClass("active-suggestion")
                          .css("background", "none")
                          .eq(p.formUtils._selectedSuggestion)
                          .addClass("active-suggestion")
                          .css(c.activeSuggestionCSS),
                        e.preventDefault(),
                        !1
                      );
                    }
      ...
      (p = e).formUtils.addValidator({
        ...
        validatorFunction: function (e) {
          ...
          if (n && r) {
            ...
            return (
              p.formUtils.validators.validate_domain.validatorFunction(t[1]) &&
              0 !== n.indexOf(".") &&
      ...
      p.formUtils.addValidator({
        ...
        validatorFunction: function (e) {
          return (
            0 < e.length &&
            e.length <= 253 &&
            !/[^a-zA-Z0-9]/.test(e.slice(-2)) &&
            !/[^a-zA-Z0-9]/.test(e.substr(0, 1)) &&
            !/[^a-zA-Z0-9\.\-]/.test(e) &&
            1 === e.split("..").length &&
            1 < e.split(".").length
          );
      ...
      p.formUtils.addValidator({
        ...
        errorMessageKey: function (e) {
          return "top" === e.errorMessagePosition ||
            "function" == typeof e.errorMessagePosition
            ? "requiredFields"
            : "requiredField";
        },
      }),
      p.formUtils.addValidator({
        ...
        validatorFunction: function (e, t, n, r) {
          ...
          var a,
            s =
              "file" === o && void 0 !== t.get(0).files
                ? t.get(0).files.length
                : e.length,
            l = p.formUtils.numericRangeCheck(s, i);
          switch (l[0]) {
            case "out":
            ...
            case "min":
              (this.errorMessage =
                r.lengthTooShortStart + l[1] + r.lengthBadEnd),
                (a = !1);
              break;
            case "max":
              (this.errorMessage =
                r.lengthTooLongStart + l[1] + r.lengthBadEnd),
                (a = !1);
              break;
            default:
              a = !0;
        ...
        validatorFunction: function (e, t, n) {
          if ("" !== e) {
            var r,
              ...
              a = t.valAttr("decimal-separator") || n.decimalSeparator,
              s = !1,
              l = t.valAttr("step") || "",
              u = !1;
            if (
              (t.attr("data-sanitize") || "").match(
                /(^|[\s])numberFormat([\s]|$)/i
              )
            ) {
              if (!window.numeral)
        ...
        validatorFunction: function (e, t, n, r) {
          ...
          if (o) {
            ...
            -1 < s.indexOf(" ") &&
              ...
              (this.errorMessage =
                r.badAlphaNumeric + r.badAlphaNumericExtra + s);
      ...
      p.formUtils.addValidator({
        ...
        validatorFunction: function (e, t, n, r, i) {
          ...
          switch (d[0]) {
            case "out":
              (this.errorMessage =
                r.groupCheckedRangeStart + u + r.groupCheckedEnd),
                (o = !1);
              break;
            case "min":
              (this.errorMessage =
                r.groupCheckedTooFewStart + d[1] + r.groupCheckedEnd),
                (o = !1);
              break;
            case "max":
              (this.errorMessage =
                r.groupCheckedTooManyStart + d[1] + r.groupCheckedEnd),
                (o = !1);
              break;
            default:
              o = !0;
            ...
            var f = function () {
              s.unbind("click", f),
                s
                  ...
                  .validateInputOnBlur(r, n, !1, "blur");
            };
            s.bind("click", f);
          }
          return o;
  ...
  (function (e) {
    ...
    function n(e, t, n, r, i, o, a, s, l, u, c, d) {
      ...
      return (
        o && (d = o(d)),
        !!w(d) &&
          (!1 !== e && 0 === parseFloat(d.toFixed(e)) && (d = 0),
          d < 0 && ((f = !0), (d = Math.abs(d))),
          !1 !== e &&
            ((m = e),
            (g = (g = d).toString().split("e")),
            (d = (+(
              (g = (g = Math.round(+(g[0] + "e" + (g[1] ? +g[1] + m : m))))
                .toString()
                .split("e"))[0] +
              "e" +
              (g[1] ? +g[1] - m : -m)
    ...
    function r(e, t, n, r, i, o, a, s, l, u, c, d) {
      ...
      return (
        c && (d = c(d)),
        !(!d || "string" != typeof d) &&
          (s && g(d, s) && ((d = d.replace(s, "")), (f = !0)),
          r && g(d, r) && (d = d.replace(r, "")),
          l && g(d, l) && ((d = d.replace(l, "")), (f = !0)),
          i &&
            ((p = i), d.slice(-1 * p.length) === p) &&
            (d = d.slice(0, -1 * i.length)),
          t && (d = d.split(t).join("")),
          n && (d = d.replace(n, ".")),
          f && (h += "-"),
          "" !== (h = (h += d).replace(/[^0-9\.\-.]/g, "")) &&
            ((h = Number(h)), a && (h = a(h)), !!w(h) && h))
      );
    }
    function i(e, t, n) {
      var r,
  ...
  (function (e) {
    ...
    function r(e, t, n, r) {
      ...
      return n
        ? (l - s) / 2 < r - s
          ...
          : s
        : t[a - 1]
        ? e[a - 1] + ((i = r - e[a - 1]), (o = t[a - 1]), Math.round(i / o) * o)
        : r;
    }
    function o(e, t, n) {
      var r;
      if (("number" == typeof t && (t = [t]), !Array.isArray(t)))
        throw new Error(
          "noUiSlider (" + Q + "): 'range' contains invalid value."
        );
      if (
        !i((r = "min" === e ? 0 : "max" === e ? 100 : parseFloat(e))) ||
        !i(t[0])
      )
    ...
    function a(e, t, n) {
      if (!t) return !0;
      n.xSteps[e] =
        d([n.xVal[e], n.xVal[e + 1]], t) / c(n.xPct[e], n.xPct[e + 1]);
    ...
    function p(e) {
      ...
      var t;
      throw new Error(
        "noUiSlider (" + Q + "): 'format' requires 'to' and 'from' methods."
      );
    }
    function h(e, t) {
      if (!i(t))
    ...
    function g(e, t) {
      ...
      if (void 0 === t.min || void 0 === t.max)
        throw new Error(
          "noUiSlider (" + Q + "): Missing 'min' or 'max' in 'range'."
        );
      if (t.min === t.max)
        throw new Error(
          "noUiSlider (" + Q + "): 'range' 'min' and 'max' cannot be equal."
        );
    ...
    function v(e, t) {
      if ("boolean" != typeof (e.snap = t))
        throw new Error(
          "noUiSlider (" + Q + "): 'snap' option must be a boolean."
        );
    }
    function y(e, t) {
      if ("boolean" != typeof (e.animate = t))
        throw new Error(
          "noUiSlider (" + Q + "): 'animate' option must be a boolean."
        );
    }
    function b(e, t) {
      if ("number" != typeof (e.animationDuration = t))
        throw new Error(
          "noUiSlider (" + Q + "): 'animationDuration' option must be a number."
        );
    }
    function x(e, t) {
      var n,
    ...
    function w(e, t) {
      switch (t) {
        ...
        default:
          throw new Error(
            "noUiSlider (" + Q + "): 'orientation' option is invalid."
          );
      }
    }
    function S(e, t) {
      if (!i(t))
        throw new Error(
          "noUiSlider (" + Q + "): 'margin' option must be numeric."
        );
    ...
    function C(e, t) {
      if (!i(t))
        throw new Error(
          "noUiSlider (" + Q + "): 'limit' option must be numeric."
        );
    ...
    function T(e, t) {
      switch (t) {
        ...
        default:
          throw new Error(
            "noUiSlider (" + Q + "): 'direction' option was not recognized."
          );
      }
    }
    function A(e, t) {
      ...
      e.events = { tap: n || o, drag: r, fixed: i, snap: o, hover: a };
    }
    function k(e, t) {
      if (!1 !== t)
        if (!0 === t) {
          ...
          if (((e.tooltips = te(t)), e.tooltips.length !== e.handles))
            throw new Error(
              "noUiSlider (" + Q + "): must pass a formatter for all handles."
            );
    ...
    function N(e, t) {
      if ("string" != typeof t && !1 !== t)
        throw new Error(
          "noUiSlider (" + Q + "): 'cssPrefix' must be a string or `false`."
        );
      e.cssPrefix = t;
    }
    function O(e, t) {
      if ("object" != typeof t)
        throw new Error(
          "noUiSlider (" + Q + "): 'cssClasses' must be an object."
        );
    ...
    function j(e, d, o) {
      ...
      function M(t, r, i) {
        ...
        return (
          ne(o, d.cssClasses.pips),
          ne(
            o,
            0 === d.ort
              ? d.cssClasses.pipsHorizontal
              : d.cssClasses.pipsVertical
          ),
          Object.keys(t).forEach(function (e) {
            !(function (e, t) {
              ...
              (n.className = c(t[1], d.cssClasses.marker)),
                (n.style[d.style] = e + "%"),
                t[1] &&
                  (((n = A(o, !1)).className = c(t[1], d.cssClasses.value)),
          ...
          s =
            ...
            g.forEach(function (e, t) {
              var n,
                ...
                f = g[t + 1];
              if (
                ("steps" === h && (n = w.xNumSteps[t]),
                n || (n = f - d),
                !1 !== d && void 0 !== f)
              )
                for (
                  n = Math.max(n, 1e-7), r = d;
                  r <= f;
                  r = (r + n).toFixed(7) / 1
                ) {
                  for (
                    l = (a = (o = w.toStepping(r)) - b) / p,
                      c = a / (u = Math.round(l)),
                      i = 1;
                    i <= u;
                    i += 1
      ...
      function j(r, i, o, a) {
        var t = function (e) {
            return (
              !!(e = (function (e, t, n) {
                ...
                (t = t || ie(S)),
                  (a || s) && ((r = e.clientX + t.x), (i = e.clientY + t.y));
                return (
                  (e.pageOffset = t),
                  (e.points = [r, i]),
                  (e.cursor = a || s),
              ...
              !(x.hasAttribute("disabled") && !a.doNotReject) &&
              ((t = x),
              (n = d.cssClasses.tap),
              !(
                (t.classList
                ...
                !(r === p.start && void 0 !== e.buttons && 1 < e.buttons) &&
                (!a.hover || !e.buttons) &&
                (h || e.preventDefault(),
        ...
        return (
          r.split(" ").forEach(function (e) {
            i.addEventListener(e, t, !!h && { passive: !0 }), n.push([e, t]);
          }),
          n
        );
      }
            ...
            (100 *
              (e -
                ...
                /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) &&
                  (a.x = 0),
                n ? r.top + a.y - o.clientTop : r.left + a.x - o.clientLeft))) /
            O();
      ...
      function q(e, t) {
        t.handle && (re(t.handle, d.cssClasses.active), (v -= 1)),
          t.listeners.forEach(function (e) {
            C.removeEventListener(e[0], e[1]);
          }),
          0 === v &&
            (re(x, d.cssClasses.drag),
            B(),
            e.cursor &&
              ((E.style.cursor = ""), E.removeEventListener("selectstart", Z))),
      ...
      function r(e) {
        ...
        d.events.snap || J(x, d.cssClasses.tap, d.animationDuration),
          ...
          $("change", n, !0),
          $("set", n, !0),
          d.events.snap && H(e, { handleNumbers: [n] });
      }
      function U(e) {
        var t = P(e.calcPoint),
          n = w.getStep(t),
      ...
      function V(e, t, n, r, i, o) {
        return (
          1 < u.length &&
            (r && 0 < t && (n = Math.max(n, e[t - 1] + d.margin)),
            i && t < u.length - 1 && (n = Math.min(n, e[t + 1] - d.margin))),
          1 < u.length &&
            d.limit &&
            (r && 0 < t && (n = Math.min(n, e[t - 1] + d.limit)),
            i && t < u.length - 1 && (n = Math.max(n, e[t + 1] - d.limit))),
          d.padding &&
            (0 === t && (n = Math.max(n, d.padding[0])),
            ...
            X(
              ...
              null === t || !1 === t || void 0 === t
                ...
                : ("number" == typeof t && (t = String(t)),
                  (t = d.format.from(t)),
                  !1 === (t = w.toStepping(t)) || isNaN(t) ? g[n] : t)),
              !0,
              !1
            );
          }),
      ...
      return (
        ne((t = x), d.cssClasses.target),
        0 === d.dir ? ne(t, d.cssClasses.ltr) : ne(t, d.cssClasses.rtl),
        0 === d.ort
          ? ne(t, d.cssClasses.horizontal)
          : ne(t, d.cssClasses.vertical),
        (l = A(t, d.cssClasses.base)),
        (function (e, t) {
          var n,
            r,
            i,
            o = A(t, d.cssClasses.connects);
          (u = []), (s = []).push(k(o, e[0]));
          for (var a = 0; a < d.handles; a++)
            u.push(
              ...
              i.setAttribute(
                "aria-orientation",
                d.ort ? "vertical" : "horizontal"
              ),
              0 === n
                ? ne(i, d.cssClasses.handleLower)
                : n === d.handles - 1 && ne(i, d.cssClasses.handleUpper),
              r)
            ),
              (m[a] = a),
              s.push(k(o, e[a + 1]));
        ...
        (f = d.events).fixed ||
          u.forEach(function (e, t) {
            j(p.start, e.children[0], H, { handleNumbers: [t] });
          }),
        f.tap && j(p.start, l, r, {}),
        f.hover && j(p.move, l, U, { hover: !0 }),
        f.drag &&
          s.forEach(function (e, t) {
            if (!1 !== e && 0 !== t && t !== s.length - 1) {
              ...
              ne(e, d.cssClasses.draggable),
                f.fixed && (i.push(n.children[0]), i.push(r.children[0])),
    ...
    return {
      ...
      create: function (e, t) {
        ...
        if (e.noUiSlider)
          throw new Error(
            "noUiSlider (" + Q + "): Slider was already initialized."
          );
        var n = j(e, oe(t), t);
